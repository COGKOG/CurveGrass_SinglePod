...
namespace
{
    ...
    void initSystem(int argc, char * argv[])
    {
        ...
        if (argc > 1){
            if (*argv[1] == 'e'){
                ...
                cout << "Error in argument. Please input e/t/r as argument" << endl;
            }
        }
        if (argc > 2){
            if (atof(argv[2]) > 0){
    ...
    void drawSystem()
    {
        ...
        GLfloat particleColor[] = {0.0f, 1.0f, 0.0f, 1.0f};
        GLfloat floorColor[] = {0.7f, 0.7f, 0.7f, 1.0f};
    ...
    void keyboardFunc( unsigned char key, int x, int y )
    {
        switch ( key )
        {
            ...
            case 'g':
            {
                cout << "grass system" << endl;
                system = new GrassSystem(num);
                break;
            }
            case 't':
            {
